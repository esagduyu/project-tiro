...
**Completed:** 21 checkpoints + UX redesign (Checkpoint 22)
...
- **Browser cache busting**: Currently at v=34 in base.html and reader.html. ALWAYS increment when modifying static files.
